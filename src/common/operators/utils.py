...
import io
from typing import BinaryIO, Any, TypeVar, cast
import traceback
import requests
import enum
import json
...
if __name__ == "__main__":
    ...
    test_file = project_root / "data" / "benchmark_data" / "gaia" / "test" / "32f386b9-73ee-4455-b412-ddad508aa979.pdf"
    breakpoint()
    result = vert.convert(str(test_file))